...
void parseFileForLabels(unsigned char *file, unsigned int fileSize, _labelList *labelList);
void addNewLabel(struct _labelList *labelList, char *compareBuf, int position);
bool parseFileForIFStatements(unsigned char *file, unsigned int fileSize, _ifStatementList *ifStatementList);
                ...
                if (argumentList[i].type == ARGTYPE_FUNCTION) { // positive match with a functionCall
                    ...
                    case FUNCTION_GPI:
                        if (argumentList[0].type == ARGTYPE_VARIABLE && argumentList[3].exist) {
                            arithAccumulator = gpiFunction((unsigned char)argumentList[3].value);
                    ...
                    case FUNCTION_GPO:
                        if (argumentList[1].exist && argumentList[2].exist) {
                            gpoFunction((unsigned char)argumentList[1].value, (unsigned char)argumentList[2].value);
                        }
                        // else{
                    ...
                    case FUNCTION_FAN:
                        if (argumentList[1].exist && (argumentList[1].type == ARGTYPE_VARIABLE || argumentList[1].type == ARGTYPE_NUMERIC)) {
                            fanFunction((unsigned char)argumentList[1].value);
                        }
                        // else{
                    ...
                    case FUNCTION_LCDW:
                        if (argumentList[1].exist && argumentList[2].exist && argumentList[2].text != NULL && argumentList[2].type == ARGTYPE_STRING) {
                            if (argumentList[3].exist && (argumentList[3].type == ARGTYPE_VARIABLE || argumentList[3].type == ARGTYPE_NUMERIC))
                                lcdPrintFunction((unsigned char)argumentList[1].value, argumentList[2].text, argumentList[3].value);
                            else
                                lcdPrintFunction((unsigned char)argumentList[1].value, argumentList[2].text, xLCD.LineSize);
                        }
                        // else{
                    ...
                    case FUNCTION_LCDC:
                        if (argumentList[1].exist && (argumentList[1].type == ARGTYPE_VARIABLE || argumentList[1].type == ARGTYPE_NUMERIC)) {
                            lcdClearLineFunction((unsigned char)argumentList[1].value);
                        }
                        // else{
                    ...
                    case FUNCTION_LCDB:
                        if (argumentList[1].exist && (argumentList[1].type == ARGTYPE_VARIABLE || argumentList[1].type == ARGTYPE_NUMERIC)) {
                            lcdBacklightFunction((unsigned char)argumentList[1].value);
                        }
                        // else{
                    ...
                    case FUNCTION_LCDP:
                        if (argumentList[1].exist && (argumentList[1].type == ARGTYPE_VARIABLE || argumentList[1].type == ARGTYPE_NUMERIC)) {
                            lcdPowerFunction((unsigned char)argumentList[1].value);
                        }
                        // else{
                    ...
                    case FUNCTION_SPIW:
                        if (argumentList[1].exist && (argumentList[1].type == ARGTYPE_VARIABLE || argumentList[1].type == ARGTYPE_NUMERIC)) {
                            SPIWrite((unsigned char)argumentList[1].value);
                        }
                        // else{
                        // printf("\nRuntime execution error. Improper LCDP function call!");
                        //}
