...
#define ScriptSavedInFlashMaxSizeInBytes Flash4KBSectorSizeInBytes - BIOSFooterReservedSpace - sizeof(_SettingsVersion) - sizeof(_OSsettings_V1) - sizeof(_LCDsettings_V1) - sizeof(EEPROMDATA) - sizeof(_ScriptSize) - sizeof(_CRC32SettingsValue)
